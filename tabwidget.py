...
class TabWidget(QTabWidget):
    ...
    def create_tab(self):
        ...
        # self.config_profile(web_view)
        web_view.setMinimumSize(400, 350)
        self.setCurrentWidget(web_view)
        return web_view

    # def config_profile(self, web_view):
    #     base_dir = 'cache'
    #     try:
    ...
    #         web_view.page().profile().setDownloadPath(download)
    #         web_view.page().profile().setCachePath(cache)
    #         # web_view.page().profile().setHttpCacheType(QWebEngineProfile.HttpCacheType.DiskHttpCache)
    #         web_view.page().profile().setPersistentStoragePath(storage)
    #         # page.profile().setPersistentCookiesPolicy(QWebEngineProfile.PersistentCookiesPolicy.ForcePersistentCookies)
    #         web_view.page().profile().setPersistentCookiesPolicy(
